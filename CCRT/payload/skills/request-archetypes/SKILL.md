...
# STATUS: CURRENT (2026-07-19). Authored for Claude Code from the v2.0 request-archetypes registry (reverse port); carriers remapped to the toolkit's actual agents+skills, Science-runtime tokens translated to Claude Code equivalents.
...
- TRIGGER TELLS: "'ecophysiology + carbon-optimality modeler, reproduce-from-l..." · "we may want to consider a SEPARATE, even broader ... agent" · "any biological-systems / dynamical model ... agent" · "please create a purely \"science writing\" style agent, based ..."
...
- TRIGGER TELLS: "please save them to a named silver/gold output folder" · "can you locate these prior filled outputs?" · "include a provenance readme in the bronze folder" · "make it one bundle, that I can share with another project"
...
- TRIGGER TELLS: "Please read the contents of [bundle] and install the toolkit" · "checking file structure in ~/.claude ..." · "Please save all outputs to [folder]" · "do file exploration on the local machine"
...
- TRIGGER TELLS: "we can do real beta-testing of this" · "it would be good to test the toolkit on a Linux box" · "we'll do all live testing on the OSX side in one go" · "When I ran the first post-verification test, I got:"
...
- TRIGGER TELLS: "fully merge/share all the projects from the two different accounts" · "port all the projects and all the skills/agents ... to ..." · "push everything ... back to account A" · "copy-migrate to [folder]"
