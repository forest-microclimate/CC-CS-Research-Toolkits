...
# STATUS: CURRENT (2026-07-14). Authored for the micromet-reconstructor agent; the vertical-grid gotchas (decompose / soft prior / broadcast globals / derive VPD / benchmark held-out level).
